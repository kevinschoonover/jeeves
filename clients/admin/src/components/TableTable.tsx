...
class SectionTable extends React.Component<ISectionTableProps, {}> {
        ...
        <Table className={classes.table}>
          <TableHead>
            <TableRow>
              ...
              <TableCell align="right">Kid Friendly</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {this.props.items.map((row) => (
              <TableRow key={row.id}>
                ...
                <TableCell align="right">{row.seatingCapacity}</TableCell>
